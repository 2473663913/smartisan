    ...
    <div id="prompt" v-if="maxShop">
        ...
        <div class="clear module-dialog module-dialog-confirm module-dialog-show" style="display: block; opacity: 1;">
            ...
            <div class="topbar">
                ...
                <span class="dialog-close png" @click="closeLimit()"></span>
            </div>
...
export default {
  computed:{
    //接收vuex中暴露的limOff
    maxShop(){
      return this.$store.state.limOff
    }
  },
  methods:{
    closeLimit(){
      this.$store.commit('closeLimit')
    }
  }
}
</script>
