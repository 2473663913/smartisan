                ...
                <div class="js-list-inner">
                    <div class="box-inner order-cart order-list-cart clear" v-for="(order,index) in orderData">
                        <div class="gray-sub-title cart-title">
                            ...
                            <span class="order-detail"><router-link :to="{name:'Payment',query:{orderId:order.orderId}}"><a href="javascript:;">查看详情&gt;</a></router-link> </span> <span class="sub-total">应付总额</span>
                            <span class="num">数量</span>
                            <span class="price">单价</span>
                        </div>
                        <div class="cart">
                            <div class="cart-items clear" v-for="(good,index) in order.goodsData">
                                <div class="prod-info clear">
                                    <div class="items-thumb">
                                        <a href="javascript:;" target="_blank"><img :src="good.ali_image+'?x-oss-process=image/resize,w_206/quality,Q_80/format,webp'"></a>
                                    </div>
                                    <div class="items-params clear">
                                        <div class="name vh-center">
                                            <a href="javascript:;" target="_blank" :title="good.title+'('+good.spec_json.show_name+')'" >{{good.title}}({{good.spec_json.show_name}})</a>
                                        </div>
                        ...
                        <div class="prod-operation">
                            ...
                            <div class="status">
                                <router-link class="blue-small-btn js-payment-order" :to="{name:'Payment',query:{orderId:order.orderId}}" v-if="!order.isPay">现在付款</router-link>
