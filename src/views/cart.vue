                ...
                <div class="cart-inner">
                    ...
                    <div v-else>
                        ...
                        <div class="cart-table">
                            <div class="cart-group" v-for="(item,index) in carPanelData">
                                <!--购物列表-->
                                <div class="cart-top-items">
                                    <div class="cart-items">
                                        <div class="items-choose">
                                            <span class="blue-checkbox-new " :class="{'checkbox-on' : item.checked }" @click="checkedChangeHandel(item.sku_id)"><a></a></span>
                                        </div>
                                        ...
                                        <div class="operation">
                                            <a class="items-delete-btn" @click="delpanelData(item.sku_id)"></a>
                                        </div>
                                        <div class="subtotal">¥ {{item.price*item.count}}.00</div>
                                        <div class="item-cols-num">
                                            <div class="select js-select-quantity">
                                                <span class="down" :class="{'down-disabled': item.count<=1}" @click="reduceCartHandel(item.sku_id)">-</span>
                                                <span class="num">{{item.count}}</span>
                                                <span class="up" :class="{'up-disabled': item.count>=item.limit_num}" @click="addCartHandel(item.sku_id)">+</span>
                    ...
                    <div class="cart-bar-operation">
                        <div>
                            <div class="choose-all js-choose-all">
                                <span class="blue-checkbox-new " :class="{'checkbox-on':allCheckde}" @click="allCheckedgoods(allCheckde)"><a></a></span>
                                全选
                            </div>
                    ...
                    <div class="shipping">
                        <div class="shipping-box">
                            ...
                            <div class="shipping-total shipping-price">
                                <h4 class="">
                                    应付总额：<span>￥</span><i >{{allCheckdeGoodsPrice}}</i> 
                                </h4>
                        ...
                        <router-link class="jianguo-blue-main-btn big-main-btn js-checkout " :class="{'disabled-btn':allCheckdeGoods<=0}" :to="{name:'Checkout'}"><a>现在结算</a></router-link>
...
export default {
    computed:{
        ...
        allCheckde(){
            return this.$store.getters.allCheckde
        },
        allCheckdeGoods(){
            return this.$store.getters.allCheckdeGoods
        },
        allCheckdeGoodsPrice(){
    ...
    methods:{
        ...
        reduceCartHandel(id){
            this.$store.commit('reduceCart',id)
        },
        checkedChangeHandel(id){
            this.$store.commit('checkedChange',id)
        },
        allCheckedgoods(allCheckde){
            this.$store.commit('allCheckedgoods',allCheckde)
        },
        delCheckedGoods(){
