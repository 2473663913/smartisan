            ...
            <div class="item-box">
                <div class="gallery-wrapper">
                    <div class="gallery">
                        <div class="thumbnail">
                            <ul>
                                <li @click="tableImg(index)" :class="{'on': index==imgIndex}" v-for="(item,index) in itemInfo.ali_images"><img :src="item+'?x-oss-process=image/resize,w_54/quality,Q_90/format,webp'"></li>
                ...
                <div class="banner">
                        ...
                        <div class="sku-dynamic-params clear">
                            ...
                            <div class="params-detail clear">
                                <div class="item-num js-select-quantity">
                                    <span class="down" :class="{'down-disabled': count<=1}" @click="reduceCount()">-</span>
                    ...
                    <div class="sku-status">
                        <div class="cart-operation-wrapper clearfix">
                            <span class="blue-title-btn js-add-cart" @click="addpanelHandel()"><a>加入购物车</a></span>
...
<script>
import itemsData from '@/lib/newItemData'
...
export default {
    ...
    //route传递过来的itemId没办法改变，通过watch来监控他的改变
    watch:{
        '$route.query.itemId' (){
    ...
    methods:{
        ...
        addpanelHandel(){
            let infoData={info:this.itemInfo,count:this.count}
